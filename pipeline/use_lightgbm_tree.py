...
if __name__ == "__main__":
    ...
    parser.add_argument('--model', '-m', type=str, default='./pipeline_helper/lgbm-model.txt',
                        help='File containing pre-trained model')
    parser.add_argument('--input_file', '-i', type=str, default='./pipeline_helper/results_for_lgbm.json',
                        help='File containing inputs')
