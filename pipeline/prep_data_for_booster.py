...
if __name__ == "__main__":
    ...
    parser.add_argument('--audio_names_file', '-n', type=str, default='./pipeline_helper/audio_nn_prediction_names.csv',
                        help='Audio names')
    parser.add_argument('--image_input_file', '-i', type=str, default='./pipeline_helper/aws_results.json',
                        help='Image JSON file')
    parser.add_argument('--out_file', '-o', type=str, default='./pipeline_helper/results_for_lgbm.json',
