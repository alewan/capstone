...
def image_processing_aws(input_dir, output_file):
    path_to_check = os.path.abspath(input_dir)

    get_full_responses = output_file if output_file is not None else False
...
if __name__ == "__main__":
    ...
    image_processing_aws(args.input_dir, args.output_file)
